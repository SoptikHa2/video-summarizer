...
**PROGRESS**: We are working on implementing much faster and efficient way to use this tool. From hours of processing to few seconds. The disadvantage is that ~~vlc media player~~  mpv will become mandatory dependency. You can track progress in the ~~`vlc`~~`mpv` branch.
